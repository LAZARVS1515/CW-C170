AFRAME.registerComponent("create-markers",{
    init:async function(){
        ...
        //to get dishes collection from firestore database
        ...
        dishes.map(dish=>{
            ...
            mainPlane.setAttribute("height", 1.7);
            ...
            titlePlane.setAttribute("material",{color:"#10efef"})
            marker.appendChild(titlePlane);

            //dish title
            var dishTitle=document.createElement("a-entity")
            dishTitle.setAttribute("id",`dishTitle-${dish.id}`);
            dishTitle.setAttribute("position", {x:0, y:0.89, z:0.02});
